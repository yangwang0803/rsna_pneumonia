...
#     """
#     IoU calculated based on segmentation. Only used for training.
#     """
    
#     def raw_iou(y_true, y_pred):
#         results = []
#         y_pred = y_pred > IOU_THRESHOLD
...
# def loss_bce_iou(y_true, y_pred, weight):
    
#     if weight>0 and weight<1:    
#         return weight * keras.losses.binary_crossentropy(y_true, y_pred) + (1-weight) * iou_segmentation(y_true, y_pred)
#     else:
#         raise ValueError('Invalid weight')


# def LearningRate(lr=0.001):
